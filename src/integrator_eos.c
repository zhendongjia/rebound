...
static const double pmlf6_a[2] = {-0.0682610383918630,0.568261038391863038121699}; // a1 a2
static const double pmlf6_b[2] = {0.2621129352517028, 0.475774129496594366806050}; // b1 b2
static const double pmlf6_c[2] = {0., 0.0164011128160783}; // c1 c2
    ...
    switch(type){
        case REB_EOS_PMLF6:
            for (int i=0;i<6;i++){
                ...
                interaction_step(r, dt*pmlf6_y[i], dt*dt*dt*pmlf6_v[i]*2.);
            }
            break;
        case REB_EOS_PMLF4:
            for (int i=0;i<3;i++){
...
void reb_integrator_eos_drift_shell0(struct reb_simulation* const r, double a){
    ...
    switch(reos->phi1){
        case REB_EOS_PMLF6:
            for (int i=0;i<n;i++){
                reb_integrator_eos_drift_shell1(r, as*pmlf6_a[0]); //TODO combine drift steps
                reb_integrator_eos_interaction_shell1(r, as*pmlf6_b[0], as*as*as*pmlf6_c[0]*2.); 
                reb_integrator_eos_drift_shell1(r, as*pmlf6_a[1]);
                reb_integrator_eos_interaction_shell1(r, as*pmlf6_b[1], as*as*as*pmlf6_c[1]*2.); 
                reb_integrator_eos_drift_shell1(r, as*pmlf6_a[1]);
                reb_integrator_eos_interaction_shell1(r, as*pmlf6_b[0], as*as*as*pmlf6_c[0]*2.);
                reb_integrator_eos_drift_shell1(r, as*pmlf6_a[0]);
            }
            break;
        case REB_EOS_PMLF4:
            ...
            break;
        case REB_EOS_LF4:
            reb_integrator_eos_drift_shell1(r, as*lf4_a);
            for (int i=0;i<n-1;i++){
                reb_integrator_eos_interaction_shell1(r, as*2.*lf4_a, 0.);
                reb_integrator_eos_drift_shell1(r, as*(0.5-lf4_a));
                reb_integrator_eos_interaction_shell1(r, as*(1.-4.*lf4_a), 0.);
                reb_integrator_eos_drift_shell1(r, as*(0.5-lf4_a));
                reb_integrator_eos_interaction_shell1(r, as*2.*lf4_a, 0.);
                reb_integrator_eos_drift_shell1(r, as*2.*lf4_a);
            }
            reb_integrator_eos_interaction_shell1(r, as*2.*lf4_a, 0.);
            reb_integrator_eos_drift_shell1(r, as*(0.5-lf4_a));
            reb_integrator_eos_interaction_shell1(r, as*(1.-4.*lf4_a), 0.);
            ...
            break;
        case REB_EOS_LF6:
            reb_integrator_eos_drift_shell1(r, as*lf6_a[0]*0.5);
            for (int i=0;i<n-1;i++){
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[0], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[0]+lf6_a[1])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[1], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[1]+lf6_a[2])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[2], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[2]+lf6_a[3])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[3], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[3]+lf6_a[4])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[4], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[3]+lf6_a[4])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[3], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[2]+lf6_a[3])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[2], 0.);
                ...
                reb_integrator_eos_drift_shell1(r, as*(lf6_a[0]+lf6_a[1])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf6_a[0], 0.);
                reb_integrator_eos_drift_shell1(r, as*lf6_a[0]);
            }
            reb_integrator_eos_interaction_shell1(r, as*lf6_a[0], 0.);
            reb_integrator_eos_drift_shell1(r, as*(lf6_a[0]+lf6_a[1])*0.5);
            reb_integrator_eos_interaction_shell1(r, as*lf6_a[1], 0.);
            ...
            break; 
        case REB_EOS_LF8: 
            reb_integrator_eos_drift_shell1(r, as*lf8_a[0]*0.5);
            for (int i=0;i<n-1;i++){
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[0], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[0]+lf8_a[1])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[1], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[1]+lf8_a[2])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[2], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[2]+lf8_a[3])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[3], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[3]+lf8_a[4])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[4], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[4]+lf8_a[5])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[5], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[5]+lf8_a[6])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[6], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[6]+lf8_a[7])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[7], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[7]+lf8_a[8])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[8], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[7]+lf8_a[8])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[7], 0.);
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[6]+lf8_a[7])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[6], 0.);
                ...
                reb_integrator_eos_drift_shell1(r, as*(lf8_a[0]+lf8_a[1])*0.5);
                reb_integrator_eos_interaction_shell1(r, as*lf8_a[0], 0.);
                reb_integrator_eos_drift_shell1(r, as*lf8_a[0]);
            }
            reb_integrator_eos_interaction_shell1(r, as*lf8_a[0], 0.);
            reb_integrator_eos_drift_shell1(r, as*(lf8_a[0]+lf8_a[1])*0.5);
            reb_integrator_eos_interaction_shell1(r, as*lf8_a[1], 0.);
...
void reb_integrator_eos_part2(struct reb_simulation* const r){
    ...
    if (reos->is_synchronized){
        ...
        switch(reos->phi0){
            case REB_EOS_PMLF6:
                reb_integrator_eos_drift_shell0(r, 2.*dt*pmlf6_a[0]); 
                break;
            case REB_EOS_PMLF4:
                reb_integrator_eos_drift_shell0(r, dt); 
                break;
            case REB_EOS_LF4:
                reb_integrator_eos_drift_shell0(r, 2.*dt*lf4_a);
                break;
            case REB_EOS_LF4_2:
    ...
    switch(reos->phi0){
        case REB_EOS_PMLF6:
            reb_integrator_eos_interaction_shell0(r, dt*pmlf6_b[0], dt*dt*dt*pmlf6_c[0]*2.); 
            reb_integrator_eos_drift_shell0(r, dt*pmlf6_a[1]);
            reb_integrator_eos_interaction_shell0(r, dt*pmlf6_b[1], dt*dt*dt*pmlf6_c[1]*2.); 
            reb_integrator_eos_drift_shell0(r, dt*pmlf6_a[1]);
            reb_integrator_eos_interaction_shell0(r, dt*pmlf6_b[0], dt*dt*dt*pmlf6_c[0]*2.);
            break;
        case REB_EOS_PMLF4:
